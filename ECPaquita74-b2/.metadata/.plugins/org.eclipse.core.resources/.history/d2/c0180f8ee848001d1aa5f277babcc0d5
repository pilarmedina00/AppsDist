			...
			if (actividadesHash != null) {
				...
				if (!nombresActividades.isEmpty()) {
					...
					for (String id : nombresActividades.keySet()) {
						out.println("<b>Identificafor: </b>" + id + "<b><br>Nombre: </b>" + nombresActividades.get(id) + "<br><br>");
					}
				} else {
				...
				out.println("<html><head><h2>Aún no se han registrado actividades en la aplicación. </h2></head><body>");
				out.println("<h2>Prueba de nuevo en unos segundos.</h2>");
				// Cierre de la página
				out.println("</body>");
				out.println("</html>");
			...
			if (actividadesHash != null) {
				...
				if (!nombresActividades.isEmpty()) {
					out.println(
							"<html><head><h2>Actividades del mes " + mes + " del año " + anyo + "</h2></head><body>");
					for (String id : nombresActividades.keySet()) {
						out.println("<b>Identificafor: </b>" + id + "<br><b>Nombre: </b>" + nombresActividades.get(id) + "<br><br>");					}
				} else {
					// Obtiene la URL de gestionar calendario
					String referer = "/ECPaquita74/calendario";
					// Establece la cabecera de refresco
